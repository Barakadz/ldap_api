...
def logging_mongodb(function):
    ...
    def wrapper(*args, **kwargs):
        ...
        functions = {"authHelpdesk": "helpdesk", "authMyCheckup": "mycheckup", "authMyDocs": "mydocs", "authMyCard": "mycard",
                     "authHPM": "hpm", "authRyadcom": "ryadcom", "authQRGenerator": "qrgenerator", "authElmedina": "elmedina", "authHpsProd": "HpsProd", "authPumaPrd": "pumaprd", "authMdmCmrs": "mdmcmrs", "authPumaTrn": "pumatrn", "authGshPst": "gshpst", "authPumaLabs": "pumalabs", "authPumaImport": "pumaimport", "authHmdmFt": "hmdmft"}
        fname = function.__name__
        now = datetime.now()
        year = now.strftime("%Y")
